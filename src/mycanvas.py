...
class MyCanvas(QtOpenGL.QGLWidget):
    ...
    def paintGL(self):
        ...
        #checamos se o primeiro ponto foi coletado (linecount==1), caso sim, atualizamos conforme movimento do mouse para desenhar
        if(self.linecount == 1):
    ...
    def mouseReleaseEvent(self, event):
        ...
        if(self.mode == 0):
            ...
            #se o primeiro ponto foi coletado, coletamos o segundo ponto e adicionamos o segmento ao model
                ...
                self.linecount=0 #resetando contagem de pontos para proxima coleta
                pt0_U = self.convertPtCoordsToUniverse(self.m_pt0)
                pt1_U = self.convertPtCoordsToUniverse(self.m_pt1)
